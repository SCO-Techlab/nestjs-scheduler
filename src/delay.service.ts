...
export class DelayService extends SchedulerContext {
  ...
  private delayDecoratorExecutionCounter: number = 0;
  ...
  constructor(private readonly schedulerService: SchedulerService) {
    ...
    this.schedulerService
      .subscribeToTask('delays_delay_1_service')
    ...
    this.schedulerService
      .subscribeToTask('delays_delay_1_decorator')
      .subscribe((data: ScheduleTask) => {
  ...
  async decoratorDelay1() {
    this.delayDecoratorExecutionCounter++;
    return of(this.delayDecoratorExecutionCounter);
  }
}
