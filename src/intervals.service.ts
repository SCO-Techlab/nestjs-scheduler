...
export class IntervalsService extends SchedulerContext {
  ...
  private intervalsDecoratorExecutionCounter: number = 0;
  ...
  constructor(private readonly schedulerService: SchedulerService) {
    ...
    this.schedulerService
      .subscribeToTask('intervals_interval_1_service')
    ...
    this.schedulerService
      .subscribeToTask('intervals_interval_1_decorator')
      .subscribe((data: ScheduleTask) => {
  ...
  async decoratorInterval1() {
    this.intervalsDecoratorExecutionCounter++;
    return of(this.intervalsDecoratorExecutionCounter);
  }
}